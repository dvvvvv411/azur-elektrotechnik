              ...
              <div className="space-y-8">
                <div>
                  <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                    Über <span className="text-blue-700">AZUR Elektrotechnik GmbH</span>
                  </h1>
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Ein spezialisiertes Elektrotechnikunternehmen mit langjähriger Erfahrung in elektronischen Anlagen, 
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed mb-6">
                      Die AZUR Elektrotechnik GmbH ist ein erfahrenes Elektrotechnikunternehmen mit Sitz in Mainz. 
                      Unser Unternehmen hat sich auf die Erstellung elektronischer Anlagen und alle dazugehörigen Arbeiten spezialisiert 
                      und verfügt über langjährige Erfahrung in der Elektrotechnikbranche.
                    </p>
                    <p className="text-gray-700 text-base leading-relaxed">
                      Wir erstellen elektronische Anlagen aller Art und führen alle dazugehörigen Arbeiten durch, 
                      insbesondere LWL-Datentechnik und Netzwerktechnik. Dabei legen wir besonderen Wert auf 
                  ...
                  <div>
                    ...
                    <div className="bg-blue-50 p-6 border border-blue-200 rounded-lg">
                      ...
                      <p className="text-blue-700 text-base">
                        Die Erstellung elektronischer Anlagen und alle dazugehörigen Arbeiten, insbesondere LWL-Daten und Netzwerktechnik
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Was uns als Elektrotechnikunternehmen auszeichnet und antreibt
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Höchste Qualitätsstandards bei allen Elektroinstallationen. Wir verwenden nur erstklassige 
                  Komponenten und arbeiten nach neuesten technischen Vorschriften.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Jahrelange Expertise im Elektrotechnikbereich garantiert professionelle Lösungen 
                  für alle Ihre elektronischen Anlagen.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  höchsten elektrotechnischen Standards.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Breites Leistungsspektrum von LWL-Technik bis Netzwerkinstallation - alles aus einer Hand 
                  für Ihre elektronischen Anlagen.
                </p>
              </div>
            </div>
          </div>
